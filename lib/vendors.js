...
"gamesir-g4s": {
    ...
    "update": function(data) {
      ...
      state["button:A"] = data[10] >> 0 & 1;
      state["button:Y"] = data[10] >> 3 & 7;

      state["button:Left"] = +(data[11] === 0);
      state["button:Right"] = +(data[11] === 255);
      state["button:Up"] = +(data[11] === 0);
      state["button:Down"] = +(data[11] === 14);


      state['button:L2'] = data[9] >> 3 & 5;
      state['button:R2'] = data[9] >> 4 & 1;

      
      state['axis:JOYL:Y'] = data[2,3];
      state['axis:JOYL:X'] = data[0,1];
      state['axis:JOYR:Y'] = data[7];
      state['axis:JOYR:X'] = data[6];
